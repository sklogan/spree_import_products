...
* Multiple taxonomies are supported (By default, the importer looks for Taxonomy). Multiple taxonomy nesting is also supported. (See the 'Taxonomies' area below)
...
* It now uses the Ruby 1.9.3 standard CSV library (a.k.a FasterCSV).


DELAYED JOB
==============
This gem will require (or will install for you), [delayed_job](https://www.github.com/tobi/delayed_job).
Once the gem has installed and you have run migrations, you should also run `rails g delayed_job` to create the tables that delayed_job requires.
...
1. Add the gem to your Gemfile, and run bundle install.
    `gem 'import_products', :git => 'git://github.com/sklogan/spree-import-products.git'` then `bundle install`

2. `bundle exec rake railties:install:migrations FROM=spree_import_products`
...
ATTRIBUTION
==============
This extension is based on https://github.com/joshmcarthur/spree-import-products.
